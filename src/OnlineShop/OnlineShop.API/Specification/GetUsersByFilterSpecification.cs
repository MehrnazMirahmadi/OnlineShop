...
{
    public GetUsersByFilterSpecification(string? firstName, string? lastName, string? nationalCode, OrderType? orderType)
    {
        AddCriteria(u => u.IsActive); // فقط کاربران فعال
